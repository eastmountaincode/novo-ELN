...
export function PresentationModal({ attachment, onClose }: { attachment: InlineAttachmentAttrs; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/70 p-5">
      <div className="grid max-h-[90vh] w-full max-w-5xl grid-rows-[auto_minmax(0,1fr)] border border-white/10 bg-slate-900 text-white shadow-2xl shadow-slate-950/50">
        ...
        <div className="grid min-h-0 grid-rows-[minmax(0,1fr)_auto] overflow-hidden bg-slate-100 text-slate-900">
